...
public class ModItemModelProvider extends ItemModelProvider {
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, UltimateQuestMod.MODID, existingFileHelper);
    }
    ...
    protected void registerModels() {
        basicItem(UQItems.ULTRA_DUST.get());
        basicItem(UQItems.PIG_DESTROYER.get());
        basicItem(UQItems.PROCESSED_ULTRA_DUST.get());
        basicItem(UQItems.ULTRA_INGOT.get());
        basicItem(UQItems.BEDROCK_BREAKER.get());
        ...
        trimmedArmorItem(UQItems.ULTRA_BOOTS);
    }

    private void trimmedArmorItem(DeferredItem<ArmorItem> itemDeferredItem) {
        final String MOD_ID = UltimateQuestMod.MODID; // Change this to your mod id
